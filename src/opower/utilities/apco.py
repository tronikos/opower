...
class APCOUsageParser(HTMLParser):
    """HTML parser to extract OPower bearer token from APCO Usage page."""
...
class APCO(UtilityBase):
    ...
    def name() -> str:
        ...
        return "Appalachian Power Company (APCO)"
    ...
    async def async_login(
        ...
        async with session.get(
            "https://www.pse.com/en/login",  #TODO
        ...
        await session.post(
            "https://www.pse.com/api/pseauthentication/AsyncSignIn",  #TODO
            data={
        ...
        async with session.get(
            "https://www.pse.com/api/AccountSelector/GetContractAccountJson",  #TODO
            headers={"User-Agent": USER_AGENT},
            raise_for_status=True,
        ) as resp:
        ...
        usage_parser = APCOUsageParser()  #TODO

        async with session.get(
            "https://www.pse.com/en/account-and-billing/my-usage/view-my-usage",  #TODO
            headers={"User-Agent": USER_AGENT},
            raise_for_status=True,
        ) as resp:
