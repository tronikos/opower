...
LOGIN_BASE = "https://www.oru.com/sitecore/api/ssc/ConEdWeb-Foundation-Login-Areas-LoginAPI/User/0"
LOGIN_HEADERS = {
    "User-Agent": USER_AGENT,
    "Referer": "https://www.oru.com/",
}
RETURN_URL = "/en/accounts-billing/my-account/energy-use"


class Oru(UtilityBase):
    """Orange & Rockland Utilities (Oru)."""
    ...
    async def async_login(
        ...
        session.cookie_jar.clear(
            lambda cookie: cookie["domain"] == "www.oru.com"
        ...
        async with session.get(
            "https://www.oru.com/sitecore/api/ssc/ConEd-Cms-Services-Controllers-Opower/OpowerService/0/GetOPowerToken",
